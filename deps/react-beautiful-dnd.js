...
function log(type, message) {
  ...
  if (typeof parent !== 'undefined' && parent[isDisabledFlag]) {
    return;
  }
...
function getScrollListener(_ref) {
  ...
  function start() {
    ...
    unbind = bindEvents(parent, [binding]);
  }
...
var composeEnhancers = process.env.NODE_ENV !== 'production' && typeof parent !== 'undefined' && parent.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__ ? parent.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__({
...
var useIsomorphicLayoutEffect = typeof parent !== 'undefined' && typeof parent.document !== 'undefined' && typeof parent.document.createElement !== 'undefined' ? useLayoutEffect : useEffect;
...
var getWindowFromEl = (function (el) {
  return el && el.ownerDocument ? el.ownerDocument.defaultView : parent;
});
...
function useMouseSensor(api) {
  ...
  var listenForCapture = useCallback(function listenForCapture() {
    ...
    unbindEventsRef.current = bindEvents(parent, [preventForcePressBinding, startCaptureBinding], options);
...
function useKeyboardSensor(api) {
  ...
  var listenForCapture = useCallback(function tryStartCapture() {
    ...
    unbindEventsRef.current = bindEvents(parent, [startCaptureBinding], options);
  }, [startCaptureBinding]);
  useIsomorphicLayoutEffect(function mount() {
    listenForCapture();
    return function unmount() {
...
var isBodyScrollable = function isBodyScrollable() {
  ...
  var htmlStyle = parent.getComputedStyle(html);
  var htmlOverflow = {
  ...
  process.env.NODE_ENV !== "production" ? warning("\n    We have detected that your <body> element might be a scroll container.\n    We have found no reliable way of detecting whether the <body> element is a scroll container.\n    Under most circumstances a <body> scroll bar will be on the <html> element (parent.document.documentElement)\n\n    Because we cannot determine if the <body> is a scroll container, and generally it is not one,\n    we will be treating the <body> as *not* a scroll container\n\n    More information: https://github.com/atlassian/react-beautiful-dnd/blob/master/docs/guides/how-we-detect-scroll-containers.md\n  ") : void 0;
  return false;
};
...
function getBody() {
  !parent.document.body ? process.env.NODE_ENV !== "production" ? invariant(false, 'document.body is not ready') : invariant(false) : void 0;
